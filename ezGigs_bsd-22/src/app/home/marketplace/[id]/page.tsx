            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-6 text-white/90">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm sm:text-base">{listing.categoryName} - Seat {listing.seatNumber}</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <h3 className="text-lg font-semibold text-[#2C3228]">
                          {listing.user.name}
                        </h3>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                  <h3 className="text-xl font-bold text-[#2C3228] mb-6 flex items-center gap-2">
                    <svg className="w-6 h-6 text-[#8E2DE2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="p-4 rounded-xl bg-[#F4F6F0]">
                      ...
                      <div className="pt-4 border-t border-[#D3D9C9]">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          <p className="text-2xl font-bold text-[#2C3228]">
                            ...
                            if (category.name === listing.categoryName && listing.price !== category.price) {
                              ...
                              return (
                                <div key={category.name} className="flex flex-wrap items-center gap-2">
                                  <span className="text-sm text-[#4A5043] line-through whitespace-nowrap">
