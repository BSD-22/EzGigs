          ...
          <div className="w-1/2 relative hidden md:block">
            <div className="absolute inset-0 bg-gradient-to-br from-[#00D2FF] to-[#3A7BD5]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-12 text-center">
                ...
                <h2 className="text-4xl font-black mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80">Start Your Journey Here!</h2>
                <p className="text-lg text-white/80">Join our community of music lovers ✨</p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-md mx-auto">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-black mb-2">
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#1E4D8C] to-[#0A2A5E]">Create Account</span>
                  <span className="text-black ml-2">🎵</span>
                </h1>
                <p className="text-[#1E4D8C]">Join thousands of concert lovers!</p>
              </div>
              ...
              <form
                ...
                <div className="space-y-2">
                  <label
                    ...
                    <svg
                      className="w-5 h-5 mr-2 text-[#1E4D8C]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24">
                      <path
                ...
                <div className="space-y-2">
                  ...
                  />
                  {state.error?.email && <p className="text-red-500 text-sm mt-1">{state.error.email[0]}</p>}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                  />
                  {state.error?.password && <p className="text-red-500 text-sm mt-1">{state.error.password[0]}</p>}
                </div>
