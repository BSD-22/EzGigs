          ...
          <div className="w-full md:w-1/2 p-8 sm:p-12">
            <div className="max-w-md mx-auto">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-black text-[#2C3228] mb-2">Create Account 🎵</h1>
                <p className="text-[#4A5043]">Join thousands of concert lovers!</p>
              </div>
              ...
              <form action={dispatch} className="space-y-6">
                <div className="space-y-2">
                  <label htmlFor="name" className="text-[#2C3228] text-sm font-medium flex items-center">
                ...
                <div className="relative my-8">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-white/80 text-[#4A5043]">Already have an account?</span>
                  </div>
                </div>
