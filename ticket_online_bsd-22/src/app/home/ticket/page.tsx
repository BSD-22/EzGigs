                        ...
                        <div className="flex items-center gap-1.5 sm:gap-3">
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1 sm:gap-2 mb-0.5">
                              <span className="font-medium text-[#2C3228] text-[10px] sm:text-sm truncate">
                                {category.name}
                              </span>
                            ...
                            <div className="flex items-baseline gap-1 sm:gap-2">
                              <div className="flex items-baseline gap-0.5 min-w-0">
                                ...
                                <span className="text-[10px] sm:text-sm font-semibold text-[#2C3228] truncate">
                ...
                <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="relative w-full sm:w-[280px] h-[180px] sm:h-auto flex-shrink-0">
                        ...
                        <div className="absolute bottom-3 left-3 bg-white rounded-xl p-2 text-center min-w-[50px]">
                            <p className="text-lg font-semibold text-[#2C3228] leading-none">
                                {new Date(ticket.date).getDate()}
                            </p>
                            <p className="text-xs font-medium text-[#4A5043] mt-0.5">
                                {new Date(ticket.date).toLocaleDateString("id-ID", { month: "short" })}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 p-3 sm:p-4">
                        <div className="mb-3">
                            ...
                            <h3 className="text-lg sm:text-xl font-semibold text-[#2C3228] mb-1 line-clamp-2">
                                {ticket.name}
                            </h3>
